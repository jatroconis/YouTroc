...
| **sideload** | Instalar una app en Android/Android TV directamente (APK), sin pasar por una tienda. Sigue siendo el método de distribución de YouTroc —ahora un proyecto open-source y multiusuario (ver **ADR-10**)— vía releases públicas en GitHub, sin pasar por tiendas de apps. Trivial de hacer sobre su propio C6K. |
